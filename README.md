...
- Fabiano Fidêncio ([@fidencio](https://github.com/fidencio)), [NVIDIA](https://www.nvidia.com).
...
- Markus Rudy ([@burgerdev](https://github.com/burgerdev)), [Edgeless Systems](https://www.edgeless.systems/).
